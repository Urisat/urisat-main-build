...
const Partner = () => {
  return (
          ...
          <div className='h-full min-w-full mt-4 md:mt-3 z-10 p-24 bg-gradient-to-r to-black from-primary-600 rounded-3xl text-clip shadow-[16px 16px 20px #0000000c]'>
